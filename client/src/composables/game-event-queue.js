  ...
  watch(gameEvent, (newGameEvent) => {
    ...
    switch (gameEvent.event) {
      case GAME_EVENTS.INITIALIZE: {
        ...
        if (!checkTypes(
          [snapshot.gameState, snapshot.gameWinner, snapshot.currentPlayerTurn, snapshot.lastHand, snapshot.lastHandPlayer,
            snapshot.playersOrder, snapshot.playersNumCards, snapshot.playerHand],
          ['string', ['string', 'null'], 'string', ['array', 'null'], ['string', 'null'], 'array', 'object', 'array']
        )) return;
